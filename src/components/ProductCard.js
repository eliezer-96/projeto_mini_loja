...
const ProductCard = ({ product }) => {
    ...
    return (
        <>
            ...
            <Dialog header="Informações Técnicas" visible={visible} style={{ width: '90vw', maxWidth: '450px' }} onHide={() => setVisible(false)}>
                ...
                <Button label="Tenho Interesse" className="p-button-teal w-full mt-3" onClick={() => setVisible(false)} />
            </Dialog>
        </>
    );
};
